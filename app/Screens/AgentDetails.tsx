        ...
        <View style={{
            ...
            <ScrollView >
                ...
                <View style={{ flexDirection: 'row', marginTop: 10, marginBottom: 20, }}>
                    <View style={{ elevation: 4, paddingTop: 5, paddingHorizontal: 7, }}>
                        <Text style={{ textAlign: "right", fontFamily: "IRANYekan", fontSize: 16, fontWeight: "bold", }}>درباره مشاور </Text>
            ...
            <View style={{
                ...
                <TouchableOpacity style={{
                    ...
                    <View style={{paddingVertical:18, paddingHorizontal:50}}>
                        <Text style={{fontFamily: "IRANYekan", color:"#fff", fontSize: 14, fontWeight:"bold", }}>تماس با تیم مشاوره</Text>
